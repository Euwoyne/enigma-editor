...
import com.github.euwoyne.enigma_edit.lua.res.Autotile;
import com.github.euwoyne.enigma_edit.lua.res.Composer;
import com.github.euwoyne.enigma_edit.lua.res.Puzzle;
...
public class CodeData implements Iterable<Entry<String, Variable>>
{
	 ...
	 * {@link Tiles}) and a table {@code res} is populated with the constructors for the
	 * resolvers {@link Composer}, {@link Autotile} and {@link Puzzle}.
	 */
	public CodeData()
	{
