...
public class LevelInfo
{
	...
	public static class Score				// <el:score/>
	{
		enigma_edit.model.Score easy;		//     el:easy        required   "MM:SS" or "-"
		enigma_edit.model.Score difficult;	//     el:difficult   required   "MM:SS" or "-"
	}
	...
	public LevelInfo()
	{
		...
		score = new Score();
		score.easy = new enigma_edit.model.Score();
		score.difficult = new enigma_edit.model.Score();
		this.reset();
	}
